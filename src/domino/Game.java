...
//			this.gamers[i]. = new Gamer();
    ...
    public int getNumberWinner() {
        ...
        for (int i = 0; i < countGamers - 1; i++)
            if (getScore(i) > getScore(i + 1)) numberWinner = i + 1;
        return numberWinner;
    }
    ...
    public boolean isEndGame() {
        int countGamers = getCountGamers();
        for (int i = 0; i < countGamers; i++)
            if (getScore()[i] > getIntProperty("maxScore")) return true;
        return false;
    }
    ...
    public void scoreCount() {
        ...
        for (int i = 0; i < countGamers; i++) {
            ...
            if ((getScore(i) > 0) || (scores >= getIntProperty("startScore"))) setScore(i, scores + getScore(i));
        }
    }
